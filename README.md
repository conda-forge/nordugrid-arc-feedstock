...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/nordugrid-arc-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/nordugrid-arc-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add nordugrid-arc
# for installing globally
pixi global install nordugrid-arc
```
...
It is possible to list all of the versions of `nordugrid-arc` available on your platform:
...
```
pixi search nordugrid-arc --channel conda-forge
```
